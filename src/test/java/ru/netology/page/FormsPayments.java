...
public class FormsPayments {
    ...
    private final SelenideElement notificationContentDenial = $(".notifikation_status_error");
    ...
    public void completeCredit(String number, String month, String year, String holder, String cvc) {
...
public void denialAssertion() {
    notificationTitleDenial.shouldBe(Condition.text("Ошибка"), Duration.ofSeconds(13)).shouldBe(Condition.visible);
    notificationContentDenial.shouldBe(Condition.text("Ошибка! Банк отказал в проведении операции."), Duration.ofSeconds(13)).shouldBe(Condition.visible);
}
